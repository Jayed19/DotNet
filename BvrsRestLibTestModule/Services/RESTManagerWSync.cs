...
{
    internal class RESTManagerWSync
    {
        ...
        public WSyncmodel WSsyncMethod(WSyncmodel WSyncmodel)
        {
            var sw = new Stopwatch();
            var WSsyncMethodResponse = new WSyncmodel();
            try
            {
                ...
                var c = WSyncmodel.upoID;




                TLog.Info("Start calling 'Sync Check Service' service... Upozila ID:" + WSyncmodel.upoID);
                sw.Start();

                var response = _client.CheckWorkstationSyncStatus(c);
                ...
                if (response.IsSuccess)
                {
                    ...
                    WSsyncMethodResponse.upoID = WSyncmodel.upoID;
